...
import { VoiceWidget } from "../components/Widgets";
      ...
      <div className="auth-brand">
        ...
        <div className="auth-brand-copy">
          <h2 style={{ color: "#fff", fontSize: "clamp(1.6rem,3vw,2.4rem)" }}>
            Your voice is your answer.
          </h2>
          <p style={{ color: "rgba(255,255,255,.6)", marginTop: ".75rem", lineHeight: 1.65 }}>
            Track WPM, filler words, confidence score, and pauses — session by session.
          </p>
        </div>
      ...
      <div className="auth-form-panel">
        <div className="auth-card">
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "1.5rem" }}>
            ...
            <span style={{ fontSize: ".82rem", color: "var(--tone-subtle)" }}>or sign up with email</span>
            <div style={{ flex: 1, height: 1, background: "var(--line)" }} />
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: "grid", gap: "1.1rem" }}>
            <div className="form-group">
              ...
              <div className="input-wrap">
                <svg className="input-ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/></svg>
                <input
                  className="input"
                  type="text"
          ...
          <p style={{ textAlign: "center", marginTop: "1.75rem", fontSize: ".85rem", color: "var(--tone-medium)" }}>
            ...
            <Link to="/login" style={{ color: "var(--coral)", fontWeight: 600 }}>Sign in</Link>
          </p>
        </div>
      </div>
    </div>
